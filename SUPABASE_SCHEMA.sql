...
-- 1. CLEANUP / RESET (Optional - uncomment if you want to rebuild)
...
-- DROP TABLE IF EXISTS hissoh CASCADE;
...
-- ==========================================
-- 3. ENABLE ROW LEVEL SECURITY (RLS) & POLIES
-- ==========================================
-- Supabase enables RLS by default. To allow the web application to perform
-- sync operations using the public anon key, we define permissive policies.
...
-- Table: kelas
CREATE POLICY "Allow all actions for anon/auth on kelas" ON kelas 
    FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);

-- Table: mata_pelajaran
CREATE POLICY "Allow all actions for anon/auth on mata_pelajaran" ON mata_pelajaran 
    FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);

-- Table: hissoh
CREATE POLICY "Allow all actions for anon/auth on hissoh" ON hissoh 
    FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);

-- Table: semester
CREATE POLICY "Allow all actions for anon/auth on semester" ON semester 
    FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);

-- Table: tahun_ajaran
CREATE POLICY "Allow all actions for anon/auth on tahun_ajaran" ON tahun_ajaran 
    FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);

-- Table: santri
CREATE POLICY "Allow all actions for anon/auth on santri" ON santri 
    FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);

-- Table: jadwal
CREATE POLICY "Allow all actions for anon/auth on jadwal" ON jadwal 
    FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);

-- Table: absensi
CREATE POLICY "Allow all actions for anon/auth on absensi" ON absensi 
    FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);


-- ==========================================
-- 4. INSERT SEED DATA (DEFAULT DATA)
-- ==========================================
...
-- Seed: hissoh
INSERT INTO hissoh (id, nomor, jam_mulai, jam_selesai) VALUES
('h1', 1, '07:00', '07:45'),
('h2', 2, '07:45', '08:30'),
('h3', 3, '08:30', '09:15'),
('h4', 4, '09:30', '10:15'),
